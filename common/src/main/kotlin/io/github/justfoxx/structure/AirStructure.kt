...
class AirStructure : StructureFeature<StructurePoolFeatureConfig>(StructurePoolFeatureConfig.CODEC,
    ...
    companion object {
        ...
        fun createPiecesGenerator(context: StructureGeneratorFactory.Context<StructurePoolFeatureConfig>): Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> {
            ...
            val topOfWorldY = context.world().topY
            val randomY = (topLandY..topOfWorldY).random()
            blockpos = blockpos.up(randomY)
