...
public class LandStructure extends StructureFeature<StructurePoolFeatureConfig> {

    public LandStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(StructurePoolFeatureConfig.CODEC, LandStructure::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
    private static boolean isFeatureChunk(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        return
                !context.chunkGenerator().method_41053(StructureSetKeys.OCEAN_MONUMENTS, context.seed(), chunkpos.x, chunkpos.z, 10)
                &&
                topBlock.getFluidState().isEmpty();
    }
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!LandStructure.isFeatureChunk(context)) {
